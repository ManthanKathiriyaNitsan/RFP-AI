...
import {
  ...
  type CollaboratorCreditReceivedItem,
  type CollaboratorCreditReducedItem,
  type CollaboratorCreditUsedItem,
} from "@/api/collaborator-data";
...
export default function CollaboratorCreditUsage() {
  ...
  const creditsReceived: CollaboratorCreditReceivedItem[] = data?.creditsReceived ?? [];
  const creditsUsed: CollaboratorCreditUsedItem[] = data?.creditsUsed ?? [];
